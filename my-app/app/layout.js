            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                sameAs: [
                  ...
                  "https://www.instagram.com/vapra_workshop_bkn/",
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                  <div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <a href="https://twitter.com/VapraWorkshop" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-gray-400 hover:text-emerald-400 transition">
                      ...
                      <a href="https://www.instagram.com/vapra_workshop_bkn/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-emerald-400 transition">
